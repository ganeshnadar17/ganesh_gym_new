    ...
    <!-- END HEAD -->
		...
		<!-- BEGIN CONTAINER -->
           <div class="page-container">
			...
			<?php #print_r($plan_data[0]['id']); exit;?>
			
			<form action="<?php echo base_url();?>/index.php/home/addPlan" class="form-horizontal" id="form_sample_1" novalidate="novalidate" method='post' enctype="multipart/form-data">
										...
										<div class="form-body">
											<div class="alert alert-danger display-hide">
                                                ...
                                                <div class="form-group form-md-line-input">
                                                    <label class="col-md-3 control-label" for="form_control_1">Plan Name
                                                        <span class="required" aria-required="true">*</span>
                                                    </label>
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" placeholder="" name="plan_name" <?php if(isset($plan_data[0]['plan_name'])) {?> value="<?php echo $plan_data[0]['plan_name']; }?>">
                                                        <div class="form-control-focus"> </div>
                                                    </div>
                                                </div>
                                                <div class="form-group form-md-line-input">
                                                    <label class="col-md-3 control-label" for="form_control_1">Plan Code 
                                                        <span class="required" aria-required="true">*</span>
                                                    </label>
                                                    <div class="col-md-6">
