...
<html lang="en">
	...
	<table id="member_list" class="display" style="width:100%">
		...
		<?php $i = 1; foreach($allPlansList as $value) { ?>
        <tbody>
            <tr>
                <td><?php echo $i; $i++; ?> </td>
                <td><?php echo $value['plan_name']; ?></td>
                <td><?php echo $value['plan_code']; ?></td>
				<th><a href="<?php echo base_url();?>/index.php/home/plan?member_id=<?php echo $value['id'];?>" class="btn btn-circle btn-icon-only yellow"><i class="glyphicon glyphicon-pencil"> </i></a></th>
